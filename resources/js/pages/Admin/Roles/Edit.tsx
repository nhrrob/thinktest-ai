                ...
                <form onSubmit={submit} className="space-y-6">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Update the permissions assigned to this role.</CardDescription>
                        </CardHeader>
                        <CardContent>
                                    ...
                                    <Collapsible key={groupName} open={openGroups[groupName]} onOpenChange={() => toggleGroup(groupName)}>
                                        <div className="flex items-center space-x-2 rounded-lg border p-2">
                                            ...
                                            <CollapsibleTrigger className="flex flex-1 items-center space-x-2 text-left">
                                                <span className="font-medium capitalize">{groupName.replace('-', ' ')}</span>
                                                <span className="text-sm text-muted-foreground">({groupPermissions.length} permissions)</span>
