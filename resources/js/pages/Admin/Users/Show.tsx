...
import { ArrowLeftIcon, CalendarIcon, MailIcon, PencilIcon } from 'lucide-react';
            ...
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-muted-foreground">User details and assigned roles</p>
                    </div>
                        ...
                        <CardContent>
                            <div className="space-y-6">
                                {Object.entries(groupedPermissions).map(([groupName, permissions]) => (
                                    <div key={groupName}>
                                        <h4 className="mb-3 text-sm font-medium tracking-wide text-muted-foreground uppercase">{groupName}</h4>
