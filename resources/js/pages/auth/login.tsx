...
export default function Login({ status, canResetPassword, socialLoginEnabled = true }: LoginProps) {
    ...
    return (
        <AuthLayout title="Log in to your account" description="Enter your email and password below to log in">
            ...
            {socialLoginEnabled && (
                <>
                    ...
                    <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                        ...
                        <Button type="button" variant="outline" className="w-full" onClick={() => (window.location.href = route('auth.github'))} tabIndex={8}>
            ...
            {/* Demo Credentials Card - Moved to bottom */}
