        ...
        <AppLayout>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                <div>
                    ...
                    <p className="text-muted-foreground">Test the toast notification system with different message types</p>
                </div>

                <Card>
                    <CardHeader>
                        <CardTitle>Toast Notification Types</CardTitle>
                        <CardDescription>Click the buttons below to test different types of toast notifications</CardDescription>
                    </CardHeader>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>These buttons simulate Laravel flash messages that would be displayed automatically</CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                        <div className="grid grid-cols-2 gap-4">
                            <Button onClick={() => (window.location.href = '/test-toast?success=User created successfully!')} variant="default">
                                Simulate Success Flash
                            </Button>

                            <Button onClick={() => (window.location.href = '/test-toast?error=Failed to create user!')} variant="destructive">
