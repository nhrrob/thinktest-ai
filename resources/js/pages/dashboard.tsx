...
import { Activity, FileText, GitBranch, Key, TrendingUp, TrendingDown, Minus, CreditCard, Coins, ShoppingCart } from 'lucide-react';
...
export default function Dashboard({ stats, creditStatus }: DashboardProps) {
                ...
                <div className="grid gap-4 md:grid-cols-2">
                    <Card>
                        ...
                        <CardContent>
                            ...
                            <p className="text-xs text-muted-foreground">
                                {creditStatus.total_used.toFixed(1)} used of {creditStatus.total_purchased.toFixed(1)} purchased
                            </p>
                            {creditStatus.balance < 5 && (
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold text-green-600 dark:text-green-400">
                                {creditStatus.demo_credits_remaining}
                            </div>
                            <p className="text-xs text-muted-foreground">
                                Free credits remaining
                            </p>
                            {creditStatus.demo_credits_remaining === 0 && (
                                <div className="mt-2">
