...
import { Loader2, GitBranch, Shield, RefreshCw } from 'lucide-react';
                            ...
                            <SelectItem key={branch.name} value={branch.name}>
                                <div className="flex items-center justify-between w-full">
                                    <div className="flex items-center space-x-2">
                                        ...
                                        {branch.protected && (
                                            <Shield className="h-3 w-3 text-yellow-500" title="Protected branch" />
                                        )}
                                    </div>
                                    <span className="text-xs text-gray-500 ml-2">
                                        {formatCommitSha(branch.commit_sha)}
                                    </span>
                                </div>
                            </SelectItem>
                        ))}
